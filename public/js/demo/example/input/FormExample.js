/**
 * @class demo.example.input.FormExample
 * @extends build.form.Form
 */
Build('demo.example.input.FormExample', [ 'build::build.form.Form', 'build::build.ui.element.Header2', 'build::build.ui.element.Paragraph', 'build::build.form.FieldSet', 'build::build.form.container.FormControl', 'build::build.form.Label',
